      ...
      data: [
        {
          locale: 'es-ES',
          key: 'test-key',
          textsHash: '["{greeting} {name}, you have {count} messages","test-key"]',
      ...
      data: [
        {
          locale: 'es-ES',
          key: 'test-key',
          textsHash: '["Value is {value}","test-key"]',
      ...
      data: [
        {
          locale: 'es-ES',
          key: 'test-key',
          textsHash: '["You have {count} items","test-key"]',
      ...
      data: [
        {
          locale: 'es-ES',
          key: 'test-key',
          textsHash: '["Status: {active}","test-key"]',
      ...
      data: [
        {
          locale: 'es-ES',
          key: 'test-key',
          textsHash: '["Items: {items}","test-key"]',
